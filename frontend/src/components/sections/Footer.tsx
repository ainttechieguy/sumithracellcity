...
export default function Footer() {
  return (
    <footer className="bg-[#f5f5dc] text-gray-600 pt-20 pb-10 border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm leading-relaxed">
              Serving customers since {businessData.founded} with professional smartphone repair, Apple device servicing, accessories, and genuine replacement parts.
            </p>
            <div className="flex gap-4">
              <a href="https://www.facebook.com/profile.php?id=100063467124351" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-gray-200 text-gray-700 flex items-center justify-center hover:bg-primary hover:text-white transition-colors">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="https://www.instagram.com/sumithra_cell_city" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-gray-200 text-gray-700 flex items-center justify-center hover:bg-primary hover:text-white transition-colors">
              ...
              <a href="#" className="w-10 h-10 rounded-full bg-gray-200 text-gray-700 flex items-center justify-center hover:bg-primary hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              {businessData.navLinks.map((link, i) => (
                <li key={i}>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="leading-relaxed text-gray-700">
                {businessData.contact.address.line1}, {businessData.contact.address.line2}, {businessData.contact.address.city}, {businessData.contact.address.pincode}
              </li>
              <li className="text-gray-900 font-mono">
                {businessData.contact.phone}
              </li>
              <li className="text-gray-900">
                <a href={`mailto:${businessData.contact.email}`} className="hover:text-primary transition-colors">
                  {businessData.contact.email}
                </a>
              </li>
              <li className="text-gray-700">
                {businessData.hours[0].day}: {businessData.hours[0].time}
              </li>
            </ul>
          </div>
        ...
        {/* Bottom Bar */}
        <div className="pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-6 md:gap-4 text-xs">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6 text-center md:text-right">
            ...
            <span className="text-gray-500 font-medium tracking-wide">
              Designed and Developed by <span className="text-gray-900 font-bold">AViRey Technologies Private Limited</span>
            </span>
          </div>
        </div>
      </div>
