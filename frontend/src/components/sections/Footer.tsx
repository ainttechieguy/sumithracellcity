        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.instagram.com/myvacation_travel_agency?igsh=Z2dieGNxNXdhNDVi" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-gray-200 text-gray-700 flex items-center justify-center hover:bg-primary hover:text-white transition-colors">
